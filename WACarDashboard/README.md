...
4 Download the [exported JSON file](https://raw.githubusercontent.com/markusvankempen/blinker-car-dashboard/master/training/car_workspace.json) that contains the Workspace contents.
